...
const MedicationHistory = ({ medicationId, medicationName, visible, onClose }) => {
	...
	}, [visible, medicationId, startDate, endDate, page, size, user, fetchMedicationHistory]);

	// In AllMedicationHistory.js (and MedicationHistory.js)
	...
	const handlePageChange = (newPage, newSize) => {
		...
		//setSize(newSize);
		fetchMedicationHistory(medicationId, startDate, endDate, newPage - 1, newSize); // Pass newPage and newSize
	};
